...
if __name__ == '__main__':
    ...
    for q in query_list:
        ...
        reply_A = pp.sentences_original[sims_tfidf[0][0]]
        ...
        # look for the 5 most related sentence using tfidf
        sentences_lsi = []
        ...
        for i in range(5):
            ...
            sentences_lda_original = sentences_lda_original + pp.get_sentences_original(pp.text_names[sims_lda[i][0]])
    ...
    print("The satisfication of baseline is : " + str(baseline))
